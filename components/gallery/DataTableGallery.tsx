    ...
    <div className="space-y-4">
      ...
      <DataTable
        ...
        empty={{
          ...
          description: 'Load expired domains one-per-line or via CSV to start matching them to topics.',
...
export function DataTableGallery() {
  ...
  return (
    <>
      ...
      <Section title="Checkbox" subtitle="unchecked · checked · indeterminate (select-all) · disabled">
        <div className="flex items-center gap-6">
          <label className="flex items-center gap-2 text-[13px]">
            <Checkbox checked={cb} onCheckedChange={(v) => setCb(v)} /> Interactive
          </label>
      ...
      <Section title="Pagination" subtitle="rows-per-page + range + windowed page numbers — the control every table shares">
        <Pagination
          page={page}
          pageCount={9}
