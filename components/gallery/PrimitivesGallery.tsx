...
export function PrimitivesGallery() {
  return (
    <>
      <Section
        title="Buttons"
        subtitle="primary · secondary · ghost · destructive · disabled · icon"
      >
        <div className="flex flex-wrap items-center gap-3">
          <Button>
            <Icons.topicalMap className="h-4 w-4" /> Build Topical Map{" "}
      ...
      <Section
        title="Status badges"
        subtitle="color always paired with a word — never color alone"
      >
      ...
      <Section
        title="Majestic TTF badges"
        subtitle="data palette — identical in light & dark, never recolored"
      >
      ...
      <Section
        title="Card"
        subtitle="static + interactive (hover to lift)"
      >
        <div className="grid gap-5 sm:grid-cols-2">
          <Card>
            ...
            <CardContent className="flex items-baseline gap-2">
              <span className="font-heading text-[1.625rem] font-bold tabular-nums leading-none">
                31
              </span>
      ...
      <Section
        title="Input, Label & form states"
        subtitle="focus · error · disabled; required = blue dot"
      >
        <div className="grid max-w-md gap-5">
          ...
          <div className="grid gap-1.5">
            ...
            <Input
              id="bad"
              aria-invalid
              defaultValue="wp_live_…invalid"
            />
            <p className="text-[13px] text-destructive">
              This key was rejected by WordPress. Re-copy it from Settings.
            </p>
          </div>
          <div className="grid gap-1.5">
            ...
            <Input
              id="dis"
              disabled
              placeholder="Locked while a scan runs"
            />
          </div>
        </div>
      </Section>
      ...
      <Section
        title="Skeleton"
        subtitle="loading building block — shimmer, reduced-motion → pulse"
      >
      ...
      <Section title="Separator, Avatar & Tooltip">
        <div className="flex items-center gap-4">
          <Avatar>
            <AvatarImage
              src="/brand/TopicVane-Mark-OnLight.svg"
              alt=""
            />
