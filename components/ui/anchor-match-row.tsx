...
export function AnchorMatchRow({ anchor, refDomains, totalLinks, relevancy, className, ...props }: AnchorMatchRowProps) {
  return (
    <div
      className={cn(
    ...
    >
      <span className="min-w-0 truncate">
        <span className="rounded bg-muted px-1.5 py-0.5 text-[13px] font-medium text-foreground">{anchor}</span>
      </span>
      {relevancy != null && <RelevancyMeter value={relevancy} className="hidden sm:flex" />}
