...
export function ScoreRing({
  ...
  return (
    ...
    >
      ...
      >
        {/* biome-ignore lint/a11y/noSvgWithoutTitle: score-ring is decorative — aria-hidden */}
        <svg
          width={size}
          height={size}
          className="-rotate-90"
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          {/* biome-ignore lint/a11y/useAriaPropsSupportedByRole: animated count-up counter — provides accessible label for screen readers */}
          <span
            ref={numRef}
